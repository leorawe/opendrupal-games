 ...
 *
 * @FieldFormatter(
 *   id = "opendrupal_pegi_ref_link",
 *   label = @Translation("Pegi icon + link"),
 ...
 * )
 */
class PegiLinkFieldFormatter extends EntityReferenceFormatterBase implements ContainerFactoryPluginInterface {
  /**
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    foreach ($this->getEntitiesToView($items, $langcode) as $delta => $entity) {
      ...
      $item = $entity->{OPENDRUPAL_PEGI_TERM_IMAGE_FIELD}[0];
